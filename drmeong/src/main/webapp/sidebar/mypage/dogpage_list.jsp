...
<body>
	...
	String id;%>
					...
					<%
						System.out.println("dog add action");
				...
				<form action="DogAddAction.me" method="post">
					<table class="memberinfotable">
						...
						<tr>
							<td width=170><p>보호자 아이디</p></td>
							<td><input type="text" name="MEMBER_ID" value="<%=dto.getMEMBER_ID()%>"></td>
						</tr>

						<tr>
							<td><p>강아지 이름</p></td>
							<td><input type="text" name="DOG_NAME" value="<%=dto.getDOG_NAME()%>"></td>
						</tr>

						<tr>
							<td><p>강아지 생년월일</p></td>
							<td><input type="text" name="DOG_BYEAR" value="<%=dto.getDOG_BYEAR()%>" size="6">년&nbsp; 
								<input type="text" name="DOG_BMONTH" value="<%=dto.getDOG_BMONTH()%>" size="6">월&nbsp;
								<input type="text" name="DOG_BDATE" value="<%=dto.getDOG_BDATE()%>" size="6">일&nbsp;
								</td>
						</tr>
						...
						<tr>
							<td><p>강아지 나이</p></td>
							<td><input type="text" name="DOG_AGE" value="<%=dto.getDOG_AGE()%>"></td>
						</tr>


						<tr>
							<td><p>견종</p></td>
							<td><input type="text" name="DOG_BREED" value="<%=dto.getDOG_BREED()%>"></td>
						</tr>

						<tr>
							<td><p>강아지 성별</p></td>
							<td><input type="text" name="DOG_SEX" value="<%=dto.getDOG_SEX()%>"></td>
						</tr>


						<tr>
							<td><p>강아지 몸무게</p></td>
							<td><input type="text" name="DOG_WEIGHT" value="<%=dto.getDOG_WEIGHT()%>">KG</td>
						</tr>
			...
			<div class="row marketing">
				<div class="col-lg-6">
					<h4>질병 정보 출처</h4>
					<p>https://terms.naver.com/list.nhn?cid=58401&categoryId=58401<br>네이버 강아지 질병사전</p>

					<h4>약품 정보 출처</h4>
					<p>http://anipharm.net/anidict<br> 동물양품사전 : 대한동물약품협회</p>
