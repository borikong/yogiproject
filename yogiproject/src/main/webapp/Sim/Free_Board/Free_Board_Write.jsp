...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/Sim/Free_Board/Board.css">
</head>
<body>
	...
	<div class="board_wrap" style="position: relative; z-index: 1;">
		...
		<form action="Free_Board/Free_Board.do?free=writeProc" method="post"
			...
			<div class="board_write_wrap">
				...
				<div class="board_write">
					...
					<div class="info">
						<dl>
							<dt>작성자</dt>
							<dd>
								<input type="text" placeholder="작성자 입력" name="writer" value="${loginID eq null?'':loginID }">
							</dd>
						</dl>
						<dl>
							<dt>비밀번호</dt>
				...
				<div class="bt_wrap">
					<!-- 버튼 영역 -->
					<input type="submit" value="등록" class="on"> <input
						type="button" value="취소"
						onclick="javascript:window.location='?free=list'">
				</div>
			</div>
		</form>
	</div>
