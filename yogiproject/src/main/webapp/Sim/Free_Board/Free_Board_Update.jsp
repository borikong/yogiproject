...
<body>
	...
	<div class="board_wrap" style="position: relative; z-index: 1;">
		...
		<form
			action="Free_Board.do?free=updateProc&no=${freevo.no}&pageNo=${pageNo}"
			method="post" name="updateForm" onsubmit="return updateSave()">
			...
			<div class="board_write_wrap">
				...
				<div class="board_write">
					...
					<div class="cont">
						<textarea placeholder="내용 입력" name="content">${freevo.title }</textarea>
					</div>
				</div>
				<div class="bt_wrap">
					<!-- 버튼 영역 -->
					...
					<input
						...
						onclick="document.location.href='Free_Board.do?free=content&no=${freevo.no }&pageNo=${pageNo }'">
				</div>
			</div>
		</form>
	</div>
