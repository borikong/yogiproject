...
<link rel="stylesheet" href="${pageContext.request.contextPath}/Sim/Banner/Banner.css">
...
<jsp:include page="/common/navbar.jsp"></jsp:include>
	...
	<div class="carousel" style="position: relative; z-index: 1;"  data-flickity='{"autoPlay": 5000, "wrapAround": true, "selectedAttraction": 0.01, "friction": 0.15 }'>	<!-- 스크립트 불러와서 그 안에 있는 값 사용(자동재생 5초에 1회, 반복 true) -->
		<div class="carousel-cell" style="background-image: url(${pageContext.request.contextPath}/Sim/Banner/Banner_pic/00001.png)"></div>
		<div class="carousel-cell" style="background-image: url(${pageContext.request.contextPath}/Sim/Banner/Banner_pic/00002.png)"></div>
		<div class="carousel-cell" style="background-image: url(${pageContext.request.contextPath}/Sim/Banner/Banner_pic/00003.png)"></div>
	</div>
</body>
</html>