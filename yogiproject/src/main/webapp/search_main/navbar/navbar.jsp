...
<div class="nav_menu">
	<ul style="list-style-type: none">
		<li style="display: inline"><a class="nav_a" href="../mem/login.jsp">로그인</a></li>
		<li style="display: inline"><a class="nav_a" href="../mem/mem.do?cmd=regForm">회원가입</a></li>
		<li style="display: inline"><a class="nav_a" href="../mem/mem.do?cmd=mypage">마이페이지</a></li>
	</ul>
</div>
<nav class="navbar_yogi">
	...
	<ul class="navbar_menu">
		...
		<li><a class="nav_a" href="../search_main/Index.de">여행지탐색</a></li>
	</ul>
